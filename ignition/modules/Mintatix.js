...
module.exports = buildModule("Mintatix", (m) => {
  ...
  const EVENT_TICKET_PRICE = ethers.parseEther("0.01") //price of the tickets
  const EVENT_MAX_SUPPLY = 50000n //max supply of tickets for the events
  ...
  const EVENT_MAX_TICKETS_PER_ADDRESS = 15n //max tickets per address for the events
